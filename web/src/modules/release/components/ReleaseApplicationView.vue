...
import { Edit, MoreFilled, Plus, Refresh, View } from '@element-plus/icons-vue'
import UiDataTable from '../../../components/ui/UiDataTable.vue'
import UiEmptyState from '../../../components/ui/UiEmptyState.vue'
import UiStatusTag from '../../../components/ui/UiStatusTag.vue'
import UiToolbar from '../../../components/ui/UiToolbar.vue'
import ReleaseSearchSelect from './ReleaseSearchSelect.vue'
import type { ReleaseApplicationDto, ReleaseApplicationStatusCode } from '../../../api/release'
...
const emit = defineEmits<{
  query: [query: { page: number; size: number; keyword?: string; status?: ReleaseApplicationStatusCode }]
  refresh: []
  create: []
...
watch([selectedApplicationCode, status], () => query(1))
  ...
  <div class="release-application-view">
    <UiToolbar>
      <ReleaseSearchSelect
        ...
        remote
        @search="emit('search-options', $event)"
      />
