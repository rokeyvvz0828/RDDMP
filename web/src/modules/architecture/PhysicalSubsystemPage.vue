...
// 项目切换后原系统的详情上下文失效，关闭抽屉避免跨项目展示过期数据。
watch(() => projectContext.currentRef, () => { detailOpen.value = false })
</script>
