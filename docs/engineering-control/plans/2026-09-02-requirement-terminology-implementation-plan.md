...
| `server/.../db/migration/V132__requirement_terminology_rename.sql` | candidate-new | 存量数据与列注释迁移 |
...
- 新建：`V132__requirement_terminology_rename.sql`
