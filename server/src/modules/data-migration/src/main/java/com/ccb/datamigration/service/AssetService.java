...
public class AssetService {
    ...
    private void ensureProject(long id, AuthUser u) { if (jdbc.queryForObject("SELECT COUNT(*) FROM dm_project WHERE id = ? AND tenant_id = ? AND deleted = 0", Integer.class, id, u.tenantId()) == 0) throw new BusinessException(ErrorCode.BAD_REQUEST, "Project not found"); }
