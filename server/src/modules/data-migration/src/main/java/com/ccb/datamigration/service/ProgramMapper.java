...
public interface ProgramMapper {
    Long count(@Param("tenantId") long tenantId, @Param("projectId") long projectId, @Param("programType") String programType, @Param("systemCode") String systemCode, @Param("keyword") String keyword);
    List<Map<String, Object>> page(@Param("tenantId") long tenantId, @Param("projectId") long projectId, @Param("programType") String programType, @Param("systemCode") String systemCode, @Param("keyword") String keyword, @Param("limit") int limit, @Param("offset") long offset);
