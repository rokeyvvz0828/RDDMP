...
@PreAuthorize("hasAnyAuthority('data-migration:access','data-migration:write','data-migration:manage','system:admin','data-migration:dashboard','data-migration:assets','data-migration:content:reports','data-migration:recycle-bin')")
public class AssetController {
    ...
    @GetMapping("/assets/check-md5") public ApiResponse<Map<String, Boolean>> checkMd5(@RequestParam String md5, @AuthenticationPrincipal AuthUser user) { return ApiResponse.success(Map.of("available", service.isMd5Available(md5, user)), TraceId.getOrCreate()); }
