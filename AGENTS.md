...
- 业务表单元数据必须遵循 `docs/integration/business-form-metadata-contract.md`：实现业务功能的 Agent 必须随任务自动维护 scope、分区、字段、规则、选项和 mock/初始化数据；系统设置页面只能作为审阅、发布和应急维护入口，不能把首次配置责任交给研发人员。
